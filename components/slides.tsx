...
function CoverSlide() {
  return (
    <>
      ...
      <div style={{ position: "relative", zIndex: 1, display: "grid", gridTemplateColumns: "1fr auto", alignItems: "center", gap: "4vw" }}>
        <div>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
          {[
            ...
            <div key={n.lbl} className="card-hover" style={{ background: "var(--surface)", border: "1px solid var(--rim)", borderRadius: 10, padding: ".9rem 1.4rem", textAlign: "center" }}>
              <p style={{ fontSize: ".57rem", textTransform: "uppercase", letterSpacing: ".1em", color: "var(--slate)", marginBottom: ".3rem" }}>{n.lbl}</p>
              <p style={{ fontSize: ".9rem", fontWeight: 700, color: "var(--bright)", whiteSpace: "pre-line", lineHeight: 1.4 }}>{n.name}</p>
            </div>
          ))}
  ...
  return (
    <>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        {/* Featured */}
        <div className="card-hover" style={{ background: "var(--surface)", backgroundImage: "radial-gradient(ellipse 55% 70% at 5% 50%, rgba(255,74,82,.09) 0%, transparent 70%)", border: "1px solid var(--rim)", borderRadius: 12, padding: "1.1rem 1.5rem", display: "flex", gap: "1.5rem", alignItems: "center", marginBottom: ".65rem" }}>
  ...
  return (
    <>
      ...
      <div style={{ position: "relative", zIndex: 2 }}>
        <Label color="amber">Q&amp;A Break · 2 min</Label>
        <Divider />
        <H2 style={{ color: "var(--amber)", marginTop: "1.2rem" }}>Questions so far?</H2>
        <Lead>What would you build if your AI agent lived inside Telegram or WhatsApp?</Lead>
        <p style={{ marginTop: "1.5rem", fontSize: ".85rem", color: "var(--slate)" }}>Coming up: 30 minutes of live building →</p>
      </div>
    </>
  )
}
  ...
  return (
    <>
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: "68%" }}>
        <Label color="teal">Live Demo · 30 min</Label>
...
function QABreak2() {
  return (
    <>
      ...
      <SectionTag section="demo" />
      <div style={{ position: "relative", zIndex: 2 }}>
        <Label color="amber">Q&amp;A Break · 3 min</Label>
        <Divider />
        <H2 style={{ color: "var(--amber)", marginTop: "1.2rem" }}>Try it yourself.</H2>
  ...
  return (
    <>
      ...
      <div style={{ position: "relative", zIndex: 2 }}>
        <Label color="amber">Q&amp;A Break · 3 min</Label>
        <Divider />
        <H2 style={{ color: "var(--amber)", marginTop: "1.2rem" }}>What else can it do?</H2>
        <Lead>Ask anything about the demo. What would you want to change or extend?</Lead>
        <p style={{ marginTop: "1.5rem", fontSize: ".85rem", color: "var(--slate)" }}>Coming up: project ideas + open Q&amp;A →</p>
      </div>
    </>
  )
}
...
function OpenQASlide() {
  return (
    <>
      ...
      <SectionTag section="qa" />
      <div style={{ position: "relative", zIndex: 2 }}>
        <Label color="amber">Open Q&amp;A · 20 min</Label>
        <Divider />
        <H2 style={{ color: "var(--amber)", marginTop: "1.2rem" }}>What are you<br />going to build?</H2>
